...
class GridProductAdapter(val listProduct: ArrayList<Product>) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): GridViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context).inflate(R.layout.grid_product, viewGroup, false)
